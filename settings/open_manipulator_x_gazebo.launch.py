...
def generate_launch_description():
    ...
    tf2_basic_path = get_package_share_directory('tf2_basic')
    custom_world_path = os.path.join(tf2_basic_path, 'world', 'empty_world.sdf')
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            ':' + os.path.join(tf2_basic_path, 'models'),
        ],
    )
